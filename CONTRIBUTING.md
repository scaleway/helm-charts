...
- The concerned chart (name and version)
...
- Open a pull request against `helm-charts` master branch that follows [PR guidelines](#pull-request-guidelines)

The maintainers of `helm-charts` use a "Let's Get This Merged" (LGTM) message in the pull request to note that the commits are ready to merge.
